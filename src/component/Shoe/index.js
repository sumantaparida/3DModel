...
function Shoe(props) {
    ...
    const { nodes, materials } = useGLTF("shoe-draco.glb"); // NOTE: 3D file
    // NOTE: Animate model
    useFrame((state) => {
    ...
    // NOTE: Cursor showing current color
    ...
    // NOTE: Using the GLTFJSX output here to wire in app-state and hook up events
    return (
      <group
        ref={ref}
        {...props}
